...
// ToMessage converts a apitypes Attachment to a [message.Attachment].
...
// AttachmentFromMessage converts a [message.Attachment] to an API type
// Attachment.
...
// AttachmentsToMessage converts a slice of apitypes Attachments to a slice
