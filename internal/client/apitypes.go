...
func (c *Client) ListWorkspaces(ctx context.Context) ([]apitypes.Workspace, error) {
...
func (c *Client) CreateWorkspace(ctx context.Context, ws apitypes.Workspace) (*apitypes.Workspace, error) {
...
func (c *Client) GetWorkspace(ctx context.Context, id string) (*apitypes.Workspace, error) {
	...
	go func() {
		...
		for {
			...
			case pubsub.PayloadTypeLSPEvent:
				var e pubsub.Event[apitypes.LSPEvent]
				_ = json.Unmarshal(p.Payload, &e)
				sendEvent(ctx, events, e)
			case pubsub.PayloadTypeMCPEvent:
				var e pubsub.Event[apitypes.MCPEvent]
				_ = json.Unmarshal(p.Payload, &e)
				sendEvent(ctx, events, e)
			case pubsub.PayloadTypePermissionRequest:
				var e pubsub.Event[apitypes.PermissionRequest]
				_ = json.Unmarshal(p.Payload, &e)
				sendEvent(ctx, events, e)
			case pubsub.PayloadTypePermissionNotification:
				var e pubsub.Event[apitypes.PermissionNotification]
				_ = json.Unmarshal(p.Payload, &e)
				sendEvent(ctx, events, e)
			case pubsub.PayloadTypeMessage:
				var e pubsub.Event[apitypes.Message]
				_ = json.Unmarshal(p.Payload, &e)
				sendEvent(ctx, events, e)
			case pubsub.PayloadTypeSession:
				var e pubsub.Event[apitypes.Session]
				_ = json.Unmarshal(p.Payload, &e)
				sendEvent(ctx, events, e)
			case pubsub.PayloadTypeFile:
				var e pubsub.Event[apitypes.File]
				_ = json.Unmarshal(p.Payload, &e)
				sendEvent(ctx, events, e)
			case pubsub.PayloadTypeAgentEvent:
				var e pubsub.Event[apitypes.AgentEvent]
				_ = json.Unmarshal(p.Payload, &e)
				sendEvent(ctx, events, e)
			case pubsub.PayloadTypeSkillsEvent:
				var e pubsub.Event[apitypes.SkillsEvent]
				_ = json.Unmarshal(p.Payload, &e)
				sendEvent(ctx, events, e)
			default:
...
func (c *Client) GetLSPs(ctx context.Context, id string) (map[string]apitypes.LSPClientInfo, error) {
	...
	var lsps map[string]apitypes.LSPClientInfo
...
func (c *Client) MCPGetStates(ctx context.Context, id string) (map[string]apitypes.MCPClientInfo, error) {
	...
	var states map[string]apitypes.MCPClientInfo
...
func (c *Client) GetAgentInfo(ctx context.Context, id string) (*apitypes.AgentInfo, error) {
...
func (c *Client) SendMessage(ctx context.Context, id string, sessionID, prompt string, attachments ...message.Attachment) error {
	rsp, err := c.post(ctx, fmt.Sprintf("/workspaces/%s/agent", id), nil, jsonBody(apitypes.AgentMessage{
		SessionID:   sessionID,
		Prompt:      prompt,
		Attachments: apitypes.AttachmentsFromMessage(attachments),
	}), http.Header{"Content-Type": []string{"application/json"}})
	if err != nil {
...
func (c *Client) GetAgentSessionInfo(ctx context.Context, id string, sessionID string) (*apitypes.AgentSession, error) {
	...
	var info apitypes.AgentSession
	if err := json.NewDecoder(rsp.Body).Decode(&info); err != nil {
...
// ListMessages retrieves all messages for a session as apitypes types.
func (c *Client) ListMessages(ctx context.Context, id string, sessionID string) ([]apitypes.Message, error) {
...
// GetSession retrieves a specific session as a apitypes type.
func (c *Client) GetSession(ctx context.Context, id string, sessionID string) (*apitypes.Session, error) {
...
// ListSessionHistoryFiles retrieves history files for a session as apitypes types.
func (c *Client) ListSessionHistoryFiles(ctx context.Context, id string, sessionID string) ([]apitypes.File, error) {
...
// CreateSession creates a new session in a workspace as a apitypes type.
func (c *Client) CreateSession(ctx context.Context, id string, title string) (*apitypes.Session, error) {
	rsp, err := c.post(ctx, fmt.Sprintf("/workspaces/%s/sessions", id), nil, jsonBody(apitypes.Session{Title: title}), http.Header{"Content-Type": []string{"application/json"}})
	if err != nil {
...
// ListSessions lists all sessions in a workspace as apitypes types.
func (c *Client) ListSessions(ctx context.Context, id string) ([]apitypes.Session, error) {
...
func (c *Client) GrantPermission(ctx context.Context, id string, req apitypes.PermissionGrant) error {
...
func (c *Client) SetPermissionsSkipRequests(ctx context.Context, id string, skip bool) error {
	rsp, err := c.post(ctx, fmt.Sprintf("/workspaces/%s/permissions/skip", id), nil, jsonBody(apitypes.PermissionSkipRequest{Skip: skip}), http.Header{"Content-Type": []string{"application/json"}})
	if err != nil {
...
func (c *Client) GetPermissionsSkipRequests(ctx context.Context, id string) (bool, error) {
	...
	var skip apitypes.PermissionSkipRequest
...
// SaveSession updates a session in a workspace, returning a apitypes type.
func (c *Client) SaveSession(ctx context.Context, id string, sess apitypes.Session) (*apitypes.Session, error) {
...
// ListUserMessages retrieves user-role messages for a session as apitypes types.
func (c *Client) ListUserMessages(ctx context.Context, id string, sessionID string) ([]apitypes.Message, error) {
...
// ListAllUserMessages retrieves all user-role messages across sessions as apitypes types.
func (c *Client) ListAllUserMessages(ctx context.Context, id string) ([]apitypes.Message, error) {
