...
func (b *Service) FileTrackerRecordRead(ctx context.Context, workspaceID, sessionID, path string) error {
...
func (b *Service) FileTrackerLastReadTime(ctx context.Context, workspaceID, sessionID, path string) (time.Time, error) {
	ws, err := b.GetWorkspace(workspaceID)
	if err != nil {
...
func (b *Service) FileTrackerListReadFiles(ctx context.Context, workspaceID, sessionID string) ([]string, error) {
	ws, err := b.GetWorkspace(workspaceID)
	if err != nil {
		return nil, err
	}
