...
import (
	...
	hyperp "github.com/CIPFZ/agent-builder/internal/agent/hyper"
	...
	"github.com/CIPFZ/agent-builder/internal/oauth/hyper"
...
type ConfigStore struct {
	...
	globalDataPath     string   // ~/.local/share/agent-builder/agent-builder.json
	workspacePath      string   // .agent-builder/agent-builder.json
...
// disk to see if another Agent Builder session has already refreshed the token. If
...
// provide runtime configuration outside Agent Builder's normal config files.
