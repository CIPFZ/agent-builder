...
const (
	// ScopeGlobal targets the global data config (~/.local/share/agent-builder/agent-builder.json).
	ScopeGlobal Scope = iota
	// ScopeWorkspace targets the workspace config (.agent-builder/agent-builder.json).
	ScopeWorkspace
)
