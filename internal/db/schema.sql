...
CREATE TABLE runtime_compact_boundaries (
    id TEXT PRIMARY KEY,
    session_id TEXT NOT NULL,
    turn_id TEXT,
    kind TEXT NOT NULL,
...
CREATE INDEX idx_runtime_compact_boundaries_session_created_at
    ON runtime_compact_boundaries (session_id, created_at);

CREATE INDEX idx_runtime_compact_boundaries_turn_created_at
