...
// It uses hierarchical ignore checking like git does, checking .gitignore/.agent-builderignore
...
// agent-builderignore, and hidden file rules.
...
// gitignore, agent-builderignore, and hidden file rules.
