...
const AgentBuilderInfoToolName = "agent_builder_info"

//go:embed agent_builder_info.md
var agentBuilderInfoDescription string

type AgentBuilderInfoParams struct{}

func NewAgentBuilderInfoTool(
	...
	return fantasy.NewAgentTool(
		AgentBuilderInfoToolName,
		agentBuilderInfoDescription,
		func(ctx context.Context, _ AgentBuilderInfoParams, _ fantasy.ToolCall) (fantasy.ToolResponse, error) {
			return fantasy.NewTextResponse(buildAgentBuilderInfo(cfg, lspManager, allSkills, activeSkills, skillTracker)), nil
		})
}

func buildAgentBuilderInfo(cfg *config.ConfigStore, lspManager *lsp.Manager, allSkills []*skills.Skill, activeSkills []*skills.Skill, skillTracker *skills.Tracker) string {
