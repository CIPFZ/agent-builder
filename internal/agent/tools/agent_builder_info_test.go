...
func TestAgentBuilderInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildAgentBuilderInfo(cfg, nil, nil, nil, nil)
...
func TestAgentBuilderInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/agent-builder/agent-builder.json",
		"/project/.agent-builder/agent-builder.json",
	)
	output := buildAgentBuilderInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/agent-builder/agent-builder.json")
	require.Contains(t, output, "/project/.agent-builder/agent-builder.json")
}

func TestAgentBuilderInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildAgentBuilderInfo(cfg, mgr, nil, nil, nil)
...
func TestAgentBuilderInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.agent-builder",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.agent-builder")
	require.Contains(t, output, "debug = true")
}

func TestAgentBuilderInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildAgentBuilderInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildAgentBuilderInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestAgentBuilderInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()

	dir := t.TempDir()
	configPath := filepath.Join(dir, "agent-builder.json")
	...
	output := buildAgentBuilderInfo(store, nil, nil, nil, nil)
...
func TestAgentBuilderInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "agent-builder-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("agent-builder-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildAgentBuilderInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "agent-builder-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestAgentBuilderInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "agent-builder-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestAgentBuilderInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestAgentBuilderInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
