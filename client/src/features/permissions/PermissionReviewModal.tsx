      ...
      {permission ? (
        <div className="permission-review">
          <Space wrap>
            ...
            {permission.policyRuleId ? <Tag>{permission.policyRuleId}</Tag> : null}
            {permission.policyScopeKind ? <Tag>{permission.policyScopeKind}</Tag> : null}
          ...
          {permission.policyTargetSummary ? <Paragraph type="secondary">Target: {permission.policyTargetSummary}</Paragraph> : null}
